...
# Inyectar CSS para reducir márgenes y padding, optimizando la altura de la pantalla
st.markdown(
    """
    <style>
    ...
    /* Reducir márgenes de los elementos (los nombres de clases pueden variar según la versión de Streamlit) */
    .css-18e3th9 { margin: 0; }
    .css-1d391kg { margin-bottom: 0; }
    /* Ajustes generales para una vista más compacta */
...
def load_sheet(client):
    """Cargar la hoja de trabajo de Google Sheets."""
    try:
...
def main():
    ...
    # Mover búsqueda y selección de fila a la barra lateral para liberar espacio en la vista principal
    with st.sidebar:
    ...
    # Utilizar pestañas para dividir la información y el formulario en dos vistas separadas
    tabs = st.tabs(["Información", "Edición"])
    ...
    with tabs[1]:
        ...
        with st.form("formulario_edicion"):
            ...
            # Checkboxes divididos en dos columnas para comentarios
            ...
            if submit_button:
                ...
                try:
                    ...
                    if superficie_ha_float > 0:
                        ...
                        st.warning("La superficie (ha) debe ser mayor que cero para calcular plantas/ha y emisores/ha.")
                except Exception as e:
                ...
                try:
                    ...
                    st.warning(f"Error al calcular superficie (m2): {str(e)}")
